...
public class inheritence {
	public static void main(String[] args) {
		...
		for(int i=0;i<n;i++){
			...
			obj[i]=new Teache(a,b,c,d,e1,e2,e3,e4,t1,t2,t3);
		}
		s.close();
...
class Empo extends Person{
	...
	Empo(String a,int b,String c,String d,int eid,String cname,String quali,int sal){
			super(a,b,c,d);
			this.empid=eid;
...
class Teache extends Empo{
	String dept,sub;
	int t_id;
	Teache(String a,int b,String c,String d,int eid,String cname,String quali,int sal,int tid,String dep,String subj){
